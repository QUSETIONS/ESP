...
static void gfx_label_snap_timer_callback(void *arg)
{
    ...
    ESP_LOGI(TAG, "aligned_offset: %ld, text_width: %ld, scroll_offset: %ld",
             (long)(label->scroll.scroll_offset - aligned_offset),
             (long)label->scroll.text_width,
             (long)label->scroll.scroll_offset);
